...
public class createAccountController implements Initializable {
        ...
        if (validateFields() && util.validateName(username) && util.validateEmail(emailAddress) && util.validatePhoneNumber(phone)) {
            if (password.getText().equals(confirmPassword.getText())) {
                if (!helper.ifAdminExists()) {
                    Admin admin = new Admin(username.getText(), emailAddress.getText(), phone.getText(),DigestUtils.shaHex(password.getText()));
    ...
    private Boolean validateFields() {
        if (username.getText().isEmpty() || emailAddress.getText().isEmpty() || phone.getText().isEmpty() || password.getText().isEmpty() || confirmPassword.getText().isEmpty()) {
