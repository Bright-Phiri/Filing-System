    ...
    private void saveUser(ActionEvent event) {
        ...
        if (ifFieldsEmpty() && util.validateName(firstName) && util.validateName(lastName) && util.validateName(username) && util.validateEmail(email) && util.validatePhoneNumber(contact)) {
            if (editMode) {
                ...
                User user = new User(firstName.getText(), lastName.getText(), username.getText(), email.getText(), contact.getText(), role.getValue(), DigestUtils.shaHex(password.getText()));
